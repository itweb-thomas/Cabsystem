...
class CabsystemModelsDestination_city extends CabsystemModelsDefault
{
	...
	**/
	...
	function store($data=null) {
		if($row = parent::store($data)) {
			$result = array();
			$result['row'] = $row;
			$result['tr'] = CabsystemHelpersView::getHtml('destination_city', '_entry', 'destination_city', $this->getItem());
			return $result;
		}
		else {
			return false;
	...
	*/
	public function delete($id = null)
	{
		...
		$city = JTable::getInstance('destination_cities','Table');
		$city->load($id);
